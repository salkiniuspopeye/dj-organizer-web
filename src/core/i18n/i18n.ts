    ...
    resources: {
      en: {
        translation: {
          ...
          audio_error_aborted: 'Audio loading aborted.',
          audio_error_network: 'Network error during audio loading.',
          audio_error_unsupported_format: 'Unsupported audio format or corrupt file.',
          audio_error_generic_decode: 'Failed to decode audio.',
          audio_error_unknown: 'An unknown audio error occurred.',
        },
      },
      de: {
        translation: {
          ...
          audio_error_aborted: 'Audio-Ladevorgang abgebrochen.',
          audio_error_network: 'Netzwerkfehler beim Laden des Audios.',
          audio_error_unsupported_format: 'Nicht unterstütztes Audioformat oder beschädigte Datei.',
          audio_error_generic_decode: 'Fehler beim Dekodieren des Audios.',
          audio_error_unknown: 'Ein unbekannter Audiofehler ist aufgetreten.',
        },
      },
    },
  });
